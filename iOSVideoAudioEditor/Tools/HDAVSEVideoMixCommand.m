...
@implementation HDAVSEVideoMixCommand
...
- (void)mixWithAsset:(AVAsset *)mixAsset{
    ...
    if (mixAssetVideoTrack) {
        ...
        if (!(degress % 360) && !self.composition.videoInstructions.count && CGSizeEqualToSize(natureSize, self.composition.mutableComposition.naturalSize) && videoTrack) {
        ...
        }else if (!(degress % 360) && self.composition.videoInstructions.count) {
